package cuit.xsgw.pickerview.view;
...
import cuit.xsgw.pickerview.R;
import cuit.xsgw.pickerview.configure.PickerOptions;
import cuit.xsgw.pickerview.listener.OnDismissListener;
import cuit.xsgw.pickerview.utils.PickerViewAnimateUtil;
...
public class BasePickerView {
    ...
    public void show(View v, boolean isAnim, boolean isBottom) {
        this.clickView = v;
        this.isAnim = isAnim;
    ...
    public void show(boolean isAnim, boolean isBottom) {
        show(null, isAnim, isBottom);
    }
