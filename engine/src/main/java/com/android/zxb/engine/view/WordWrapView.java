...
/**
 * 自动换行的view
 * created by zhaoxiangbin on 2019/7/12 17:11
 * 460837364@qq.com
 */
public class WordWrapView extends ViewGroup {
    private static int PADDING_HOR;//子view水平方向padding
    private static int PADDING_VERTICAL;//子view垂直方向padding
    private static int TEXT_MARGIN_HOR;//子view之间的水平间距
    private static int TEXT_MARGIN_VERTICAL;//行间距
    ...
    private void initPadding() {
        PADDING_HOR = DisplayUtils.dp2px(getContext(), 15);
        PADDING_VERTICAL = DisplayUtils.dp2px(getContext(), 5);
        TEXT_MARGIN_HOR = DisplayUtils.dp2px(getContext(), 15);
        TEXT_MARGIN_VERTICAL = DisplayUtils.dp2px(getContext(), 10);
    }
