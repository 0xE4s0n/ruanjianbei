...
import com.android.zxb.engine.emotionapp.utils.SpanStringUtils;
import com.android.zxb.engine.util.CopyStringUtil;
 ...
 * 可展开/收起的文本控件
 * <p>
 * created by zhaoxiangbin on 2019/4/3 08:42
 * 460837364@qq.com
 */
public class ExpandableTextView extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        //长按复制到剪切板监听
        mContentTextView.setOnLongClickListener(v -> {
            if (CopyStringUtil.copyString(context, mContentTextView.getText())) {
    ...
    public void setText(CharSequence text) {
        ...
        mContentTextView.setText(SpanStringUtils.getEmotionContent(EMOTION_CLASSIC_TYPE, getContext(), mContentTextView, mContent.toString()));                     // 设置文本
